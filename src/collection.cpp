...
void spawn(const char *name, double xd, double yd, double zd, int c) {
  ...
  ros::ServiceClient spawn_model_client = nh
      .serviceClient<gazebo_msgs::SpawnModel>("gazebo/spawn_sdf_model");
  ...
  s << "<?xml version='1.0'?>\
      <sdf version='1.7'>\ <model name='Box1'>\
   <link name='link_0'>\ <inertial>\ <mass>0.000994789</mass>\
   <inertia>\ <ixx>1.61419e-06</ixx>\ <ixy>0</ixy>\ <ixz>0</ixz>\
   <iyy>1.71568e-06</iyy>\ <iyz>0</iyz>\ <izz>1.63752e-06</izz>\
   </inertia>\<pose>0 0 0 0 -0 0</pose>\</inertial>\
   <pose>0 0 -0 0 -0 0</pose>\<visual name='visual'>\
   <pose>0 0 0 0 -0 0</pose>\<geometry>\<box>\
   <size>0.5 0.5 0.5</size>\</box>\</geometry>\<material>\
   <lighting>1</lighting>\<script>\
   <uri>file://media/materials/scripts/gazebo.material</uri>\
   <name>Gazebo/Grey</name>\</script>\<shader type='pixel'/>";
...
void remove_ob(const char *name) {
  ...
  ros::ServiceClient delete_model_client = n
      .serviceClient<gazebo_msgs::DeleteModel>("gazebo/delete_model");
